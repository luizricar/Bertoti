...
Estudante do curso de Banco de Dados na Fatec Jessen Vidal de São José dos Campos. Boa parte de minhas experiências profissionais são em mecânica de usinagem, porém desde 2024.1 tenho participado de projetos de API na Fatec, onde a cada semestre a equipe da qual faço parte resolve problemas propostos pela própria Fatec ou por empresas parceiras, e ao final apresentamos nossa proposta em uma feira de soluções realizada pela própria Fatec. Estas experiências tem contribuido muito para meu crescimento técnico, tanto prático quanto teórico.


# **Contatos**

GIT: https://github.com/luizricar

LinkedIn: https://www.linkedin.com/in/luiz-ricardo-mendes/


# **Meus Principais Conhecimentos**
Tenho sólidos conhecimentos em Java, principalmente no desenvolvimento de aplicações desktop e web, utilizando boas práticas de programação orientada a objetos. Em Python, possuo experiência no desenvolvimento de scripts para automação de tarefas, análise de dados e integração de sistemas. Já em R, aplico meus conhecimentos na manipulação, visualização e análise estatística de dados, com foco em insights que apoiem a tomada de decisão.
Meu objetivo é continuar desenvolvendo essas habilidades e ampliar meu domínio em projetos que envolvam análise de dados, inteligência artificial e soluções corporativas.
